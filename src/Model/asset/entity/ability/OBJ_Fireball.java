...
public class OBJ_Fireball extends Projectile {
    ...
    public OBJ_Fireball(GameController gameController) {
    ...
    public void getAnimationImages() {
        ...
        setUp1(setup("/resources/images/ability/fireball_up_1", width, height));
        setUp2(setup("/resources/images/ability/fireball_up_2", width, height));
        setDown1(setup("/resources/images/ability/fireball_down_1", width, height));
        setDown2(setup("/resources/images/ability/fireball_down_2", width, height));
        setLeft1(setup("/resources/images/ability/fireball_left_1", width, height));
        setLeft2(setup("/resources/images/ability/fireball_left_2", width, height));
